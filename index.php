...
<html lang="es">
    <head>
        ...
        <title>Denuncias de Transporte publico</title>
        <style>
            html
            {
                height: 100%;
    ...
    <body>
        <div class="header">
            <h1>Denuncias de transporte</h1>
            <p>Aplicación web para el registro de denuncias del transporte publico en Colombia</p>
            <p>Permite el control y la ayuda de la ciudadania en el tema de infraccciones de transito</p>
        </div>
        <div class="seccion">
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td><a href="eliminarDenuncias.php?id_para_borrar=<?php echo $row['id_pk']; ?>">eliminar</a></td>
                </tr>
                <?php
                }
                // cierra la conexión
